    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid>
            <div class="navbar-header">
                <a class="navbar-brand" href="temp.php">Library Management System</a>
            </div>
            <ul class="nav navbar-nav navbar-right">
                <li class="nav-item">
                    <a class="nav-link" href="temp.php">Admin Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="temp.php">User Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="temp.php">Regiister Login</a>
                </li>
            </ul>
        </div>
    </nav>
